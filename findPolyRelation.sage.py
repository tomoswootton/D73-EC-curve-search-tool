...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_3677 = Integer(3677); _sage_const_26687 = Integer(26687); _sage_const_3673 = Integer(3673); _sage_const_11 = Integer(11); _sage_const_71389 = Integer(71389); _sage_const_179 = Integer(179); _sage_const_30 = Integer(30); _sage_const_25 = Integer(25); _sage_const_27181 = Integer(27181); _sage_const_37 = Integer(37); _sage_const_152 = Integer(152)
import subprocess
...
for u in range(_sage_const_0 ,_sage_const_30 ):
    data = [_sage_const_3 ,_sage_const_11 ,_sage_const_179 ],[_sage_const_152 ,_sage_const_37 ],u,_sage_const_25 ,_sage_const_100 
    print("------------------------------------------------")
    print("START")
    print("\nNew data:")
    print(data)
