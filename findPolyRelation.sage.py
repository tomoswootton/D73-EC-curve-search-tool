...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_103 = Integer(103)
import subprocess
...
def printECCcodeSamples(curve,u,v,numEntries):
    ...
    for iso in isos:
        print("point ")
        print(iso)
        genECCCodeIsogency([curve,[iso[_sage_const_0 ],iso[_sage_const_1 ]],u,v,numEntries])
...
printECCcodeSamples([_sage_const_0 ,_sage_const_7 ,_sage_const_103 ],_sage_const_2 ,_sage_const_2 ,_sage_const_5 )


# findPolyRealationsAX64([[0,7,103],32,92,98,100],"ScalarMult")
# data = [0,7,107],[98, 54],2,2,100
# findPolyRealationsAX64(data,"Isogeny")
